# ztegritycoin RPC Commands and arguments
...
The configuration file is not automatically created; you can create it using your favorite plain-text editor. By default, ztegritycoin-qt (or ztegritycoind) will look for a file named ztegritycoin.conf in the ztegritycoin data directory, but both the data directory and the configuration file path may be changed using the -datadir and -conf command-line arguments.

| Platform	   |Path to data folder           | Typical path to configuration file                                                 |
|------------|--------------------------------|------------------------------------------------------------------------------------|
| Linux	     | ~/	                            | /home/username/.ztegritycoin/ztegritycoin.conf                                               |
| macOS      | ~/Library/Application Support/	| /Users/username/Library/Application Support/Eletra/ztegritycoin.conf                    |
| Windows	   | %APPDATA%	                    | (Vista-10) C:\Users\username\AppData\Roaming\ztegritycoin\ztegritycoin.conf                  |
|            |                                | (2000-XP) C:\Documents and Settings\username\Application Data\ztegritycoin\ztegritycoin.conf |

Note: if running ztegritycoin in testnet mode, the sub-folder testnet will be appended to the data directory automatically. Command line arguments

## These commands are accurate as of ztegritycoin Core version 2.0.0:
...
## ztegritycoind Options

Start ztegritycoin Core Daemon with option:
<table>
<tr> <td>ztegritycoind</td><td>[options]</td></tr>
</table>
...
<tr> <td>--conf=<file></td><td>Specify configuration file (default: ztegritycoin.conf)</td></tr>
...
<tr> <td>--pid=<file></td><td>Specify pid file (default: ztegritycoind.pid)</td></tr>
...
<tr> <td>--reindexmoneysupply</td><td>Reindex the ztegritycoin and zECA money supply statistics on startup</td></tr>
...
<tr> <td>--paytxfee=<amt></td><td>Fee (in ztegritycoin/kB) to add to transactions you send (default: 0.00)
...
<tr> <td>--minrelaytxfee=<amt></td><td>Fees (in ztegritycoin/Kb) smaller than this are considered zero fee for relaying (default: 0.0001)
...
<tr> <td>-litemode=<n></td><td>Disable all ztegritycoin specific functionality (Masternodes, Zerocoin, wiftX, Budgeting) (0-1, default: 0)
</table>
...
<tr> <td>--ecastake=<n></td><td>Enable or disable staking functionality for ztegritycoin inputs (0-1, default: 1)
...
This documentation lists all available RPC commands as of ztegritycoin version 2.0.0, and limited documentation on what each command does. For full documentation of arguments, results and examples, type help ( “command” ) to view full details at the console. You can enter commands either from Tools > Debug console in the QT wallet, or using ztegritycoin-cli
...
#### debug ( 0 | 1 | addrman | alert | bench | coindb | db | lock | rand | rpc | selectcoins | mempool | mempoolrej | net | proxy | prune | http | libevent | ztegritycoin )
...
#### preparebudget "proposal-name" "url" payment-count block-start "ztegritycoin-address" monthy-payment
...
#### submitbudget "proposal-name" "url" payment-count block-start "ztegritycoin-address" monthy-payment "fee-tx"
...
PoW Only: Return if the server is set to generate coins or not. The default is false. It is set with the command line argument -gen (or ztegritycoin.conf setting gen) It can also be set with the setgenerate call.
...
#### validateaddress “ztegritycoinaddress”

Return information about the given ztegritycoin address.

#### verifymessage “ztegritycoinaddress” “signature” “message”
...
#### bip38decrypt "ztegritycoinaddress" "passphrase"

Decrypts and then imports password protected private key.

#### bip38encrypt "ztegritycoinaddress" "passphrase"

Encrypts a private key corresponding to 'ztegritycoinaddress'.

#### dumpprivkey “ztegritycoinaddress”

Reveals the private key corresponding to ‘ztegritycoinaddress’. Then the importprivkey can be used with this output
...
DEPRECATED. Returns the current ztegritycoin address for receiving payments to this account.
...
Returns a new ztegritycoin address for receiving payments. If ‘account’ is specified (DEPRECATED), it is added to the address book so payments received with the address will be credited to ‘account’.

#### getrawchangeaddress

Returns a new ztegritycoin address, for receiving change. This is for use with raw transactions, NOT normal use.

#### getreceivedbyaccount “account” ( minconf addlockconf )

DEPRECATED. Returns the total amount received by addresses with <account> in transactions with specified minimum number of confirmations.

#### getreceivedbyaddress “ztegritycoinaddress” ( minconf addlockconf )

Returns the total amount received by the given ztegritycoinaddress in transactions with specified minimum number of confirmations.
...
#### importprivkey “ztegritycoinprivkey” ( “label” rescan )
...
#### sendfrom “fromaccount” “toztegritycoinaddress” amount ( minconf addlockconf “comment” “comment-to” )

DEPRECATED (use sendtoaddress). Sent an amount from an account to a ztegritycoin address.
...
#### sendtoaddress “ztegritycoinaddress” amount ( “comment” “comment-to” subtractfeefromamount use_is use_ps )
...
Stores the wallet decryption key in memory for ‘timeout’ seconds. This is needed prior to performing transactions related to private keys such as sending ztegritycoins
...
Usage:
  ztegritycoin-tx [options] <hex-tx> [commands]  Update hex-encoded ztegritycoin transaction
  ztegritycoin-tx [options] -create [commands]   Create hex-encoded ztegritycoin transaction
