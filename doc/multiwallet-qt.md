...
In order to support loading of multiple wallets in ztegritycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ztegritycoin.cpp.
...
Changes to ztegritycoin.cpp
----------------------
ztegritycoin.cpp is the entry point into ztegritycoin-qt, and as such, will require some minor modifications to provide hooks for
