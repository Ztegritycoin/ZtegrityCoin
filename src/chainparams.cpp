...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "ztegritycoin cryptocurrency of the future";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1616023765;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 2241228;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x6c6d4a90bd740b809c8e092dc3fee4196e0815912f5102b1747e7e05857f8fae"));
        assert(hashGenesisBlock == uint256("0x00000984b6439bd35de5a674a0cfa3b8df0baa55f86277c0dd676d6a37448b4a"));

     
		
	vSeeds.push_back(CDNSSeedData("1", "165.232.159.16"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x6c6d4a90bd740b809c8e092dc3fee4196e0815912f5102b1747e7e05857f8fae"));
        assert(hashGenesisBlock == uint256("0x000081b1784260f60efde8f9ff7cb36d9583b8d6721b6805362fdebccb16c030"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x6c6d4a90bd740b809c8e092dc3fee4196e0815912f5102b1747e7e05857f8fae"));
        assert(hashGenesisBlock == uint256("0x143b18d9bb3ab7bc5ac7caf55749460fd53cf75382e4c9b01115a5ae9497ee52"));
