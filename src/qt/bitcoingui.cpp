                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ztegritycoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&ztegritycoin Project"), this);
    webmainAction->setStatusTip(tr("ztegritycoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("ztegritycoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("ztegritycoin Twitter"));
    ...
    discordAction->setStatusTip(tr("ztegritycoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("ztegritycoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("ztegritycoin Telegram"));
    ...
    redditAction->setStatusTip(tr("ztegritycoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap ztegritycoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell ztegritycoin Coin (ztegritycoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    ztegritycoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&ztegritycoin block explorer"), this);
    ztegritycoinBlockExplorerAction->setStatusTip(tr("ztegritycoin blockchain explorer"));
    ztegritycoinBlockExplorerAction->setToolTip(ztegritycoinBlockExplorerAction->statusTip());
    ztegritycoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&ztegritycoin Project Github"), this);
    githubAction->setStatusTip(tr("ztegritycoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ztegritycoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ztegritycoin: URIs)"));
...
//    }
    ...
    connect(ztegritycoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(ztegritycoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ztegritycoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ztegritycoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ztegritycoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ztegritycoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ztegritycoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ztegritycoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ztegritycoin Core help message to get a list with possible ztegritycoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(ztegritycoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ztegritycoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.ztegritycoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/ztegritycoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/ztegritycoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/ztegritycoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/ztegritycoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::ztegritycoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/ztegritycoin/ztegritycoin/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ztegritycoin network", "", count));
}
...
{
    QString strTitle = tr("ztegritycoin Core"); // default title
