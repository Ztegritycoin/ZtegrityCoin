...
/** Utility functions used by the ztegritycoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ztegritycoin addresses in monospace font
...
// Parse "ztegritycoin:" URI into recipient object, return true on successful parsing
