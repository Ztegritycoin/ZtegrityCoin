...
/* ztegritycoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ztegritycoin"
#define QAPP_ORG_DOMAIN "ztegritycoinproject.org"
#define QAPP_APP_NAME_DEFAULT "ztegritycoin-Qt"
#define QAPP_APP_NAME_TESTNET "ztegritycoin-Qt-testnet"
