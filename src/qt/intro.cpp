...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ztegritycoin Core"),
     ...
     * override -datadir in the ztegritycoin.conf file in the default data directory
     * (to be consistent with ztegritycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
