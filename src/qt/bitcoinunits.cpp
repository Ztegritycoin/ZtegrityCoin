...
QString BitcoinUnits::id(int unit)
{
    ...
    case ztegritycoin:
        return QString("ZTCO");
    case mECA:
        return QString("mztegritycoin");
    case uECA:
        return QString::fromUtf8("uztegritycoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ztegritycoin:
            return QString("ZTCO");
        case mECA:
            return QString("Milli-ztegritycoin (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-ztegritycoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
