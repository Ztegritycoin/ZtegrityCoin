...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::ztegritycoin);
    ...
    if (!settings.contains("nAnonymizeztegritycoinAmount"))
        settings.setValue("nAnonymizeztegritycoinAmount", 1000);

    nAnonymizeztegritycoinAmount = settings.value("nAnonymizeztegritycoinAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeztegritycoinAmount"))
        SoftSetArg("-anonymizeztegritycoinamount", settings.value("nAnonymizeztegritycoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in ztegritycoin.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizeztegritycoinAmount:
            return QVariant(nAnonymizeztegritycoinAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizeztegritycoinAmount:
            nAnonymizeztegritycoinAmount = value.toInt();
            settings.setValue("nAnonymizeztegritycoinAmount", nAnonymizeztegritycoinAmount);
            emit anonymizeztegritycoinAmountChanged(nAnonymizeztegritycoinAmount);
            break;
        case CoinControlFeatures:
