...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ztegritycoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "ztegritycoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ztegritycoin features */
        {"ztegritycoin", "masternode", &masternode, true, true, false},
        {"ztegritycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ztegritycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ztegritycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ztegritycoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ztegritycoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ztegritycoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ztegritycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ztegritycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ztegritycoin", "startmasternode", &startmasternode, true, true, false},
        {"ztegritycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ztegritycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ztegritycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ztegritycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ztegritycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ztegritycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ztegritycoin", "mnbudget", &mnbudget, true, true, false},
        {"ztegritycoin", "preparebudget", &preparebudget, true, true, false},
        {"ztegritycoin", "submitbudget", &submitbudget, true, true, false},
        {"ztegritycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ztegritycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ztegritycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ztegritycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ztegritycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ztegritycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ztegritycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ztegritycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ztegritycoin", "mnsync", &mnsync, true, true, false},
        {"ztegritycoin", "spork", &spork, true, true, false},
        {"ztegritycoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ztegritycoin-cli " + methodname + " " + args + "\n";
}
