...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ztegritycoin ztegritycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ztegritycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ztegritycoin transaction") + "\n" +
                               "  ztegritycoin-tx [options] -create [commands]   " + _("Create hex-encoded ztegritycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ztegritycoin transaction
