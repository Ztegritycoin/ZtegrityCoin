Contributing to ztegritycoin Core
============================

The ztegritycoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ztegritycoin Core project, and is not to be
confused with overall ztegritycoin Network Protocol consensus changes.

Whether a pull request is merged into ztegritycoin Core rests with the project merge
...
Patches that change ztegritycoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ztegritycoin consensus, it must have been
...
The project leader is the release manager for each ztegritycoin Core release.
